        ...
        with gr.Box(visible=is_spaces):
            if(is_spaces and is_shared_ui):
                ...
                <div class="gr-prose" style="max-width: 80%">
                    ...
                    <p>You can duplicate this Space to skip the queue and enable the training, extension and settings tabs.&nbsp;&nbsp;<a class="duplicate-button" style="display:inline-block" target="_blank" href="https://huggingface.co/spaces/{os.environ['SPACE_ID']}?duplicate=true"><img style="margin: 0" src="https://img.shields.io/badge/-Duplicate%20Space-blue?labelColor=white&style=flat&logo=data:image/png;base64,&logoWidth=14" alt="Duplicate Space"></a></p> 
                </div>
                ''')
            elif(is_spaces):
                import torch
